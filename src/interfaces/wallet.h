...
public:
    ...
    virtual wallet::isminetype isMine(const CTxDestination& dest) = 0;
    ...
    virtual void availableCoins(std::vector<wallet::COutput> &vCoins, const wallet::CCoinControl *coinControl, const CAmount& nMinimumAmount) = 0;
